...
- 🔖 **[save](https://github.com/julian0xff/save)** - Save articles for reading later — from the terminal. Extracts clean text, stores in SQLite with full-text search. CLI Pocket replacement
